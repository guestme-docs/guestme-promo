...
function NowUILineChart({ data }: { data: TimePoint[] }) {
  if (data.length === 0) {
    return (
      <GradientCard>
          ...
          >
            <defs>
              <linearGradient id="areaGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="rgb(106, 232, 197)" stopOpacity={0.3}/>
                <stop offset="95%" stopColor="rgb(106, 232, 197)" stopOpacity={0.05}/>
              </linearGradient>
              <linearGradient id="lineGradient" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="rgb(106, 232, 197)" stopOpacity={0.9}/>
                <stop offset="100%" stopColor="rgb(106, 232, 197)" stopOpacity={0.6}/>
              </linearGradient>
            </defs>
...
export default React.memo(NowUILineChart);
