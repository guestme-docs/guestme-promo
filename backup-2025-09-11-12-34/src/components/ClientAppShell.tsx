    ...
    <div className="min-h-screen bg-white flex">
      <div className="w-64 bg-white border-r border-black/[.08] flex flex-col">
        <div className="p-6 border-b border-black/[.08]">
          <div className="text-xl font-bold text-black">GuestMe Promo</div>
          <div className="text-sm text-black/60 mt-1">Портал поставщика</div>
        </div>
        <div className="flex-1 p-4">
          <div className="space-y-2">
            <div className="block px-3 py-2 text-sm font-medium rounded-md text-black/60">Дашборд</div>
            <div className="block px-3 py-2 text-sm font-medium rounded-md text-black/60">Акции</div>
            <div className="block px-3 py-2 text-sm font-medium rounded-md text-black/60">Продажи</div>
            <div className="block px-3 py-2 text-sm font-medium rounded-md text-black/60">Рестораны</div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        <div className="h-16 border-b border-black/[.08] bg-white flex items-center px-6">
          <h1 className="text-lg font-semibold text-black">Портал поставщика</h1>
        </div>
